...
// initial values
#define HASH_MD5_A0 0x67452301
#define HASH_MD5_B0 0xefcdab89
#define HASH_MD5_C0 0x98badcfe
#define HASH_MD5_D0 0x10325476
// round functions
...
void hash_md5_bytes(const uint8_t * restrict array, size_t len, uint8_t * restrict hash)
{
    ...
    uint32_t h[4] = {HASH_MD5_A0,HASH_MD5_B0,HASH_MD5_C0,HASH_MD5_D0};
    while (block + 64 <= end)
    {
